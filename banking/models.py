...
class Investment(models.Model):
    ...
    min_investment = models.CharField(max_length=100, null=True,  blank=True)
    max_investment = models.CharField(max_length=100, null=True,  blank=True)
    product_length = models.CharField(max_length=100)
    rating_short_term = models.CharField(max_length=10, null=True,  blank=True)
    rating_long_term = models.CharField(max_length=10, null=True,  blank=True)
...
class InsuranceProduct(models.Model):
    ...
    min_eligibility_age = models.CharField(max_length=40, null=True, blank=True)
    max_eligibility_age = models.CharField(max_length=40, null=True, blank=True)
    max_maturity_age = models.CharField(max_length=40, null=True, blank=True)
    minimum_premium = models.CharField(max_length=12, null=True, blank=True)
