...
class InvestmentResource(resources.ModelResource):
    ...
    class Meta:
        model = Investment
        fields = ('id', 'bank_name', 'min_investment', 'max_investment',
                  'product_length', 'profit_rate', 'payout_frequency', 'choice_field')
        export_order = ('id', 'bank_name', 'min_investment', 'max_investment',
                        'product_length', 'profit_rate', 'payout_frequency', 'choice_field')
...
class InvestmentAdmin(ImportExportModelAdmin):
    ...
    list_display = ['bank', 'min_investment', 'max_investment',
                    'product_length', 'profit_rate', 'payout_frequency', 'choice_field']
